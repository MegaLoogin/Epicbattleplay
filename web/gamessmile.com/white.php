...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 1162;
        $headers['auth']['clientCompany'] = "e66UDRVkWHb0T9Qp3zov";
        $headers['auth']['clientSecret'] = "MTE2MmU2NlVEUlZrV0hiMFQ5UXAzem92Y2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
